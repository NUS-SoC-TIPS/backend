/*
  ...
  - The values [EMACS] on the enum `key_binding` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "key_binding_new" AS ENUM ('STANDARD', 'VIM', 'VS_CODE');
